<?php
/**
 * Plugin Name: BU GD Force Unique Time Slots - M Block
...
(function(){
  const slots = [
    ...
    {value:'02:00 - 04:00', label:'02:00 AM - 04:00 AM'},
    {value:'04:00 - 06:00', label:'04:00 AM - 06:00 AM'}
  ];
  ...
  function isTimeSlotSelect(select){
    ...
    return (
      ...
      optionsText.includes('04:00 am - 06:00 am')
    );
  }
